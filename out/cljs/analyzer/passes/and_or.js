...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__968){
var map__969 = p__968;
var map__969__$1 = cljs.core.__destructure_map.call(null,map__969);
var ast = map__969__$1;
var op = cljs.core.get.call(null,map__969__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
...
return cljs.core.remove.call(null,(function (p1__970_SHARP_){
return cljs.core._EQ_.call(null,local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__970_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__971 = cljs.core.update_in.call(null,ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let.call(null,G__971,local);
} else {
return G__971;
}
});
...
var map__972 = cljs.core.first.call(null,new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__972__$1 = cljs.core.__destructure_map.call(null,map__972);
var init = cljs.core.get.call(null,map__972__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.call(null,map__972__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__973 = cljs.core.first.call(null,new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__973__$1 = cljs.core.__destructure_map.call(null,map__973);
var init = cljs.core.get.call(null,map__973__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.call(null,map__973__$1,new cljs.core.Keyword(null,"name","name",1843675177));
