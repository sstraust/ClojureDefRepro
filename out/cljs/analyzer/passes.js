...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__961_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__961_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__964 = ast;
if((G__964 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__964,passes,opts);
}
