...
var seq__13804_13808 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__13805_13809 = null;
var count__13806_13810 = (0);
var i__13807_13811 = (0);
while(true){
if((i__13807_13811 < count__13806_13810)){
var str_13812 = cljs.core._nth.call(null,chunk__13805_13809,i__13807_13811);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_13812})));


var G__13813 = seq__13804_13808;
var G__13814 = chunk__13805_13809;
var G__13815 = count__13806_13810;
var G__13816 = (i__13807_13811 + (1));
seq__13804_13808 = G__13813;
chunk__13805_13809 = G__13814;
count__13806_13810 = G__13815;
i__13807_13811 = G__13816;
continue;
} else {
var temp__5457__auto___13817 = cljs.core.seq.call(null,seq__13804_13808);
if(temp__5457__auto___13817){
var seq__13804_13818__$1 = temp__5457__auto___13817;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13804_13818__$1)){
var c__5565__auto___13819 = cljs.core.chunk_first.call(null,seq__13804_13818__$1);
var G__13820 = cljs.core.chunk_rest.call(null,seq__13804_13818__$1);
var G__13821 = c__5565__auto___13819;
var G__13822 = cljs.core.count.call(null,c__5565__auto___13819);
var G__13823 = (0);
seq__13804_13808 = G__13820;
chunk__13805_13809 = G__13821;
count__13806_13810 = G__13822;
i__13807_13811 = G__13823;
continue;
} else {
var str_13824 = cljs.core.first.call(null,seq__13804_13818__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_13824})));


var G__13825 = cljs.core.next.call(null,seq__13804_13818__$1);
var G__13826 = null;
var G__13827 = (0);
var G__13828 = (0);
seq__13804_13808 = G__13825;
chunk__13805_13809 = G__13826;
count__13806_13810 = G__13827;
i__13807_13811 = G__13828;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__13833 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__13833,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__13833,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__13833,"onreadystatechange",onload);

return G__13833;
})();
if((opt_sourceText == null)){
var G__13834 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__13834,"src",src);

return G__13834;
} else {
var G__13835 = script__$1;
goog.dom.setTextContent(G__13835,opt_sourceText);
...
var path_13836 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_13836);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_13836)].join(''));
} else {
var path_13837 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_13837);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_13837);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_13837)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__13838 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__13839 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__13839);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__13838);
}})()})));
}));
